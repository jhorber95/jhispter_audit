...
import co.interedes.config.audit.AuditEventConverter;
import co.interedes.domain.PersistentAuditEvent;
...
import static co.interedes.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
